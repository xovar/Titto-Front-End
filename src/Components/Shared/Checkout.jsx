  ...
  return (
    <div className="min-h-screen bg-white max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-10">
      ...
      >
        ...
        <div className="w-full lg:w-[55%] space-y-8 text-left">
          ...
          <div>
            <div className="flex justify-between items-center mb-3">
              ...
              {/* <button
                type="button"
                className="text-xs text-neutral-600 underline bg-transparent border-none cursor-pointer"
              >
                Sign in
              </button> */}
            </div>
          ...
          <div>
            ...
            <div className="border border-neutral-300 rounded-lg overflow-hidden">
              <label
                className={`flex items-center justify-between p-4 cursor-pointer border-b border-neutral-200 ${shippingMethod === "inside" ? "bg-neutral-50" : ""}`}
              >
              ...
              <label
                className={`flex items-center justify-between p-4 cursor-pointer ${shippingMethod === "outside" ? "bg-neutral-50" : ""}`}
              >
                <div className="flex items-center gap-3">
                  <input
                    type="radio"
          ...
          <div>
            ...
            <div className="border border-neutral-300 rounded-lg overflow-hidden">
              {/* <div>
                <label
                  className={`flex items-center justify-between p-4 cursor-pointer border-b border-neutral-200 ${paymentMethod === "sslcommerz" ? "bg-neutral-50" : ""}`}
                >
                  <div className="flex items-center gap-3">
                    <input
                      type="radio"
                ...
                {paymentMethod === "sslcommerz" && (
                  <div className="p-6 bg-neutral-50 border-b border-neutral-200 text-center text-xs text-neutral-500 space-y-2">
                    ...
                    <p>
                      You'll be redirected to SSLCOMMERZ to complete your
                      purchase safely.
                    </p>
                  </div>
                )}
              ...
              <div>
                <label
                  className={`flex items-center p-4 cursor-pointer border-b border-neutral-200 ${paymentMethod === "cod" ? "bg-neutral-50" : ""}`}
                >
                  <input
                    type="radio"
                    name="paymentMethod"
                ...
                {paymentMethod === "cod" && (
                  <div className="p-4 bg-neutral-100 border-b border-neutral-200 text-xs text-neutral-700 text-left space-y-1 font-medium pl-10">
                    <p>
                      After placing your order, it will be automatically
                      confirmed.
                    </p>
                    <p className="text-neutral-500 font-normal">-</p>
                    <p className="text-neutral-900 font-semibold">
                      অর্ডারটি প্লেস করার সাথে সাথেই স্বয়ংক্রিয়ভাবে কনফার্ম
                      হবে।
                    </p>
                  </div>
                )}
              ...
              {/* <div>
                <label
                  className={`flex items-center p-4 cursor-pointer border-b border-neutral-200 ${paymentMethod === "bkash" ? "bg-neutral-50" : ""}`}
                >
                  <input
                    type="radio"
                    name="paymentMethod"
              ...
              <div>
                <label
                  className={`flex items-center p-4 cursor-pointer ${paymentMethod === "nagad" ? "bg-neutral-50" : ""}`}
                >
                  <input
                    type="radio"
                    name="paymentMethod"
          ...
          <div>
            ...
            <div className="border border-neutral-300 rounded-lg overflow-hidden bg-white">
              <label
                className={`flex items-center p-4 cursor-pointer border-b border-neutral-200 transition-colors ${billingAddress === "same" ? "bg-neutral-50" : ""}`}
              >
                <input
                  type="radio"
                  name="billingAddress"
              ...
              <label
                className={`flex items-center p-4 cursor-pointer transition-colors ${billingAddress === "different" ? "bg-neutral-50 border-b border-neutral-300" : ""}`}
              >
                <input
                  type="radio"
                  name="billingAddress"
        ...
        <div className="hidden lg:block w-full lg:w-[45%] bg-neutral-50 border border-neutral-200 rounded-2xl p-6 lg:sticky lg:top-24 z-10 space-y-6 text-left">
          <OrderSummaryContent {...summaryProps} />
        </div>
      </form>
    </div>
